    ...
    <div class="popUp">
        <el-dialog title="修改信息" class="dialog"
            ...
            <el-form :model="tempForm" :rules="rules">
                <el-form-item label="机构名称" :label-width="formLabelWidth" prop="createrId">
                    <el-input v-model="tempForm.orgName" auto-complete="off" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="姓名" :label-width="formLabelWidth" prop="name" class="must">
